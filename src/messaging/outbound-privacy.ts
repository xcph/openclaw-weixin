...
const THINKING_WRAPPED_BLOCK_RE =
...
export type OutboundPrivacyFlags = {
 ...
 */
export function sanitizeAssistantOutboundForChannel(text: string, flags: OutboundPrivacyFlags): string {
 ...
 */
function stripLeadingWeixinThinkingBubbleBody(text: string): string {
