    ...
    configSchema: {
        schema: {
            ...
            properties: {
                showReasoning: {
                    type: "boolean",
                    description: "When true, forward model reasoning/thinking to Weixin as plain-text messages (💭 prefix) and log previews on the gateway. Per-account `accounts.<id>.showReasoning` overrides this default.",
                },
            },
        },
    },
